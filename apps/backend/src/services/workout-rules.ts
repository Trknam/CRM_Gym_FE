...
export function parseLimitations(value: string | string[] | null | undefined) {
...
function matchedLimitationIds(exercise: ExerciseLike, limitations: string | string[]) {
...
export function getActiveLimitationRules(limitations: string | string[]) {
  const texts = parseLimitations(limitations).map(normalized);
